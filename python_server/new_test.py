...
b1 = tk.Label(root, text="Blue 1 Not Submitted", bg="blue", fg="white")
b1.pack(padx=5, ipady=10, side=tk.LEFT)
b2 = tk.Label(root, text="Blue 2 Not Submitted", bg="blue", fg="white")
b2.pack(padx=5, ipady=10, side=tk.LEFT)
b3 = tk.Label(root, text="Blue 3 Not Submitted", bg="blue", fg="white")
b3.pack(padx=5, ipady=10, side=tk.LEFT)
    ...
    def cont():
        ...
        if maintain:
            ...
            if not R1Submit:
                if 'T' in content[0]:
                    R1Submit = True
                    r1.configure(text="Red 1 Submitted", bg="green", fg="white")
                    r1.update()
                else:
            ...
            if not R2Submit:
                if "T" in content[1]:
                    R2Submit = True
                    r2.configure(text="Red 2 Submitted", bg="green", fg="white")
                    r2.update()
                else:
            ...
            if not R3Submit:
                if "T" in content[2]:
                    R3Submit = True
                    r3.configure(text="Red 3 Submitted", bg="green", fg="white")
                    r3.update()
                else:
            ...
            if not B1Submit:
                if "T" in content[3]:
                    B1Submit = True
                    b1.configure(text="Blue 1 Submitted", bg="green", fg="white")
                    b1.update()
                else:
            ...
            if not B2Submit:
                if "T" in content[4]:
                    B2Submit = True
                    b2.configure(text="Blue 2 Submitted", bg="green", fg="white")
                    b2.update()
                else:
            ...
            if not B3Submit:
                if "T" in content[5]:
                    B3Submit = True
                    b3.configure(text="Blue 3 Submitted", bg="green", fg="white")
                    b3.update()
                else:
