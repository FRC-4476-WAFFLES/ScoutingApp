...
#     def count():
#         global counter
#         #import the variables that keep track of which scout has submitted their data
#         global R1Submit
#         global R2Submit
#         global R3Submit
#         global B1Submit
...
gui = threading.Thread(target=mainThread())
bt = threading.Thread(target=BluetoothDaemon(), daemon=True)
bt.start().join()
gui.start().join()
